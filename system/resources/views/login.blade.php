...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{url('public')}}/dist/css/fonts/icomoon/style.css">
  ...
  <div class="d-lg-flex half">
    <div class="bg order-1 order-md-2" style="background-image: url('public/dist/img/bg_1.jpg');"></div>
    <div class="contents order-2 order-md-1">

      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-7">
            <h3>Login to <strong>Admin Shop</strong></h3>
